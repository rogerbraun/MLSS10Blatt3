function [labeling error1 error2] = performClassification2(forxDataPoints)

[apples bananas] = generateTData3();
...
%charnoff bound
error1 = calcChernoffBound(mu1,mu2,var1,var2,-1);
%bhattacharyya bound
error2 = chernoffBound2(.5, mu1, mu2, var1, var2,1);
