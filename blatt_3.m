...
results_first_feature = [test_with_files(apple_pics,c1,@featureI); test_with_files(banana_pics,c1,@featureI)];
% Trainieren und Plotten von Feature 2:
c2 = train_and_plot(@feature2,'Feature 2');
results_second_feature = [test_with_files(apple_pics,c2,@feature2); test_with_files(banana_pics,c2,@feature2)];
...
results_second_feature_reduced = [test_with_files(apple_pics,c3,@feature2_reduced); test_with_files(banana_pics,c3,@feature2_reduced)];

c4 = train_and_plot_two_features(@featureI, @feature2);
results_two_features = [test_with_files(apple_pics,c4,@feature1_2); test_with_files(banana_pics,c4,@feature1_2)];
